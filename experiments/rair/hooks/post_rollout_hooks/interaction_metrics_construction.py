...
plt.style.use("experiments/rair/hooks/post_rollout_hooks/prettyplots.mplstyle")
...
def interaction_tracker_hook(_locals, _globals, plot_trajs=False, figsize=None, **kwargs):
    ...
    if plot_trajs:
        ...
        plotting_traj(num_moved_objects, num_objects_in_air, figsize=aspect_ratios[1], save_dir=save_dir)
