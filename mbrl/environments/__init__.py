...
def env_from_string(env_string, wrappers=[], **env_params):
    env_dict = {
        ...
        # - SHAPEGRIDWORLD
        "ShapeGridworld": (".shape_gridworld_env", "ShapeGridworldEnv"),
        "ShapeGridworldColored": (".shape_gridworld_colored_env", "ShapeGridworldColoredEnv"),
        # - ROBODESK - #
        ...
        # - DMSuite - #
        "quadruped": (".dm_suite", "QuadrupedSuite"),
        "walker": (".dm_suite", "WalkerSuite"),
    }
